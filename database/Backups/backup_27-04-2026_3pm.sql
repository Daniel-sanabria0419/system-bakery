...
\restrict l5igCawJzw7Bs0q5y5nHvh9zds6QAYHl7rjFhdY7L6DutQn50f128zFFsvD4RWc

-- Dumped from database version 18.3 (Homebrew)
-- Dumped by pg_dump version 18.2

-- Started on 2026-04-27 15:09:08 -05
...
-- Name: detalles_produccion; Type: TABLE; Schema: public; Owner: daniel
--
...
CREATE TABLE public.detalles_produccion (
    ...
    CONSTRAINT chk_detalles_produccion_cantidad_esperada CHECK ((cantidad_esperada > (0)::numeric)),
    CONSTRAINT chk_detalles_produccion_cantidad_real CHECK ((cantidad_real >= (0)::numeric))
);


ALTER TABLE public.detalles_produccion OWNER TO daniel;

--
-- TOC entry 265 (class 1259 OID 16970)
-- Name: detalles_produccion_id_seq; Type: SEQUENCE; Schema: public; Owner: daniel
--
...
ALTER SEQUENCE public.detalles_produccion_id_seq OWNER TO daniel;

--
-- TOC entry 4276 (class 0 OID 0)
-- Dependencies: 265
-- Name: detalles_produccion_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: daniel
--
...
--
-- TOC entry 260 (class 1259 OID 16906)
-- Name: detalles_receta; Type: TABLE; Schema: public; Owner: daniel
--
...
CREATE TABLE public.detalles_receta (
    ...
    CONSTRAINT chk_detalles_receta_cantidad CHECK ((cantidad > (0)::numeric))
);


ALTER TABLE public.detalles_receta OWNER TO daniel;

--
-- TOC entry 259 (class 1259 OID 16905)
-- Name: detalles_receta_id_seq; Type: SEQUENCE; Schema: public; Owner: daniel
--

CREATE SEQUENCE public.detalles_receta_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.detalles_receta_id_seq OWNER TO daniel;

--
-- TOC entry 4277 (class 0 OID 0)
-- Dependencies: 259
-- Name: detalles_receta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: daniel
--

ALTER SEQUENCE public.detalles_receta_id_seq OWNED BY public.detalles_receta.id;
...
-- Name: estados_produccion; Type: TABLE; Schema: public; Owner: daniel
--

CREATE TABLE public.estados_produccion (
    id bigint NOT NULL,
...
ALTER TABLE public.estados_produccion OWNER TO daniel;

--
-- TOC entry 261 (class 1259 OID 16927)
-- Name: estados_produccion_id_seq; Type: SEQUENCE; Schema: public; Owner: daniel
--

CREATE SEQUENCE public.estados_produccion_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.estados_produccion_id_seq OWNER TO daniel;

--
-- TOC entry 4281 (class 0 OID 0)
-- Dependencies: 261
-- Name: estados_produccion_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: daniel
--

ALTER SEQUENCE public.estados_produccion_id_seq OWNED BY public.estados_produccion.id;
...
--
-- TOC entry 268 (class 1259 OID 16994)
-- Name: pasos_receta; Type: TABLE; Schema: public; Owner: daniel
--
...
ALTER TABLE public.pasos_receta OWNER TO daniel;

--
-- TOC entry 267 (class 1259 OID 16993)
-- Name: pasos_receta_id_seq; Type: SEQUENCE; Schema: public; Owner: daniel
--

CREATE SEQUENCE public.pasos_receta_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.pasos_receta_id_seq OWNER TO daniel;

--
-- TOC entry 4285 (class 0 OID 0)
-- Dependencies: 267
-- Name: pasos_receta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: daniel
--

ALTER SEQUENCE public.pasos_receta_id_seq OWNED BY public.pasos_receta.id;


--
-- TOC entry 264 (class 1259 OID 16946)
-- Name: producciones; Type: TABLE; Schema: public; Owner: daniel
--
...
ALTER TABLE public.producciones OWNER TO daniel;

--
-- TOC entry 263 (class 1259 OID 16945)
-- Name: producciones_id_seq; Type: SEQUENCE; Schema: public; Owner: daniel
--
...
ALTER SEQUENCE public.producciones_id_seq OWNER TO daniel;

--
-- TOC entry 4286 (class 0 OID 0)
-- Dependencies: 263
-- Name: producciones_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: daniel
--
...
-- Name: recetas; Type: TABLE; Schema: public; Owner: daniel
--
...
CREATE TABLE public.recetas (
    ...
    activo boolean DEFAULT true NOT NULL,
    fecha_creacion timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT chk_recetas_cantidad_resultado CHECK ((cantidad_resultado > (0)::numeric))
);


ALTER TABLE public.recetas OWNER TO daniel;

--
-- TOC entry 257 (class 1259 OID 16874)
-- Name: recetas_id_seq; Type: SEQUENCE; Schema: public; Owner: daniel
--
...
ALTER SEQUENCE public.recetas_id_seq OWNER TO daniel;

--
-- TOC entry 4288 (class 0 OID 0)
-- Dependencies: 257
-- Name: recetas_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: daniel
--
...
--
-- TOC entry 3835 (class 2604 OID 16541)
...
--
-- TOC entry 3854 (class 2604 OID 16725)
...
--
-- TOC entry 3879 (class 2604 OID 16974)
-- Name: detalles_produccion id; Type: DEFAULT; Schema: public; Owner: daniel
--
...
--
-- TOC entry 3873 (class 2604 OID 16909)
-- Name: detalles_receta id; Type: DEFAULT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.detalles_receta ALTER COLUMN id SET DEFAULT nextval('public.detalles_receta_id_seq'::regclass);


--
-- TOC entry 3843 (class 2604 OID 16619)
...
--
-- TOC entry 3821 (class 2604 OID 16427)
...
--
-- TOC entry 3874 (class 2604 OID 16931)
-- Name: estados_produccion id; Type: DEFAULT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.estados_produccion ALTER COLUMN id SET DEFAULT nextval('public.estados_produccion_id_seq'::regclass);


--
-- TOC entry 3818 (class 2604 OID 16410)
...
--
-- TOC entry 3832 (class 2604 OID 16524)
...
--
-- TOC entry 3849 (class 2604 OID 16672)
...
--
-- TOC entry 3868 (class 2604 OID 16833)
...
--
-- TOC entry 3880 (class 2604 OID 16997)
-- Name: pasos_receta id; Type: DEFAULT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.pasos_receta ALTER COLUMN id SET DEFAULT nextval('public.pasos_receta_id_seq'::regclass);


--
-- TOC entry 3877 (class 2604 OID 16949)
-- Name: producciones id; Type: DEFAULT; Schema: public; Owner: daniel
--
...
--
-- TOC entry 3860 (class 2604 OID 16755)
...
--
-- TOC entry 3870 (class 2604 OID 16878)
-- Name: recetas id; Type: DEFAULT; Schema: public; Owner: daniel
--
...
--
-- TOC entry 3815 (class 2604 OID 16393)
...
--
-- TOC entry 3863 (class 2604 OID 16795)
...
--
-- TOC entry 3829 (class 2604 OID 16506)
...
--
-- TOC entry 3846 (class 2604 OID 16655)
...
--
-- TOC entry 3865 (class 2604 OID 16815)
...
--
-- TOC entry 3851 (class 2604 OID 16710)
...
--
-- TOC entry 3826 (class 2604 OID 16489)
...
--
-- TOC entry 3857 (class 2604 OID 16740)
...
--
-- TOC entry 3824 (class 2604 OID 16449)
...
--
-- TOC entry 3839 (class 2604 OID 16571)
...
--
-- TOC entry 4234 (class 0 OID 16538)
-- Dependencies: 234
...
--
-- TOC entry 4246 (class 0 OID 16722)
-- Dependencies: 246
...
--
-- TOC entry 4266 (class 0 OID 16971)
-- Dependencies: 266
-- Data for Name: detalles_produccion; Type: TABLE DATA; Schema: public; Owner: daniel
--

COPY public.detalles_produccion (id, produccion_id, receta_id, cantidad_esperada, cantidad_real) FROM stdin;
\.


--
-- TOC entry 4260 (class 0 OID 16906)
-- Dependencies: 260
-- Data for Name: detalles_receta; Type: TABLE DATA; Schema: public; Owner: daniel
--

COPY public.detalles_receta (id, receta_id, producto_insumo_id, cantidad) FROM stdin;
\.


--
-- TOC entry 4238 (class 0 OID 16616)
-- Dependencies: 238
...
--
-- TOC entry 4224 (class 0 OID 16424)
-- Dependencies: 224
...
--
-- TOC entry 4262 (class 0 OID 16928)
-- Dependencies: 262
-- Data for Name: estados_produccion; Type: TABLE DATA; Schema: public; Owner: daniel
--

COPY public.estados_produccion (id, nombre, descripcion, activo, fecha_creacion) FROM stdin;
\.


--
-- TOC entry 4222 (class 0 OID 16407)
-- Dependencies: 222
...
--
-- TOC entry 4232 (class 0 OID 16521)
-- Dependencies: 232
...
--
-- TOC entry 4242 (class 0 OID 16669)
-- Dependencies: 242
...
--
-- TOC entry 4256 (class 0 OID 16830)
-- Dependencies: 256
...
--
-- TOC entry 4268 (class 0 OID 16994)
-- Dependencies: 268
-- Data for Name: pasos_receta; Type: TABLE DATA; Schema: public; Owner: daniel
--

COPY public.pasos_receta (id, receta_id, orden_paso, titulo, descripcion, temperatura, tiempo_minutos, fecha_creacion) FROM stdin;
\.


--
-- TOC entry 4264 (class 0 OID 16946)
-- Dependencies: 264
-- Data for Name: producciones; Type: TABLE DATA; Schema: public; Owner: daniel
--

COPY public.producciones (id, fecha_programada, fecha_inicio, fecha_fin, usuario_id, estado_produccion_id, observaciones, fecha_creacion) FROM stdin;
\.


--
-- TOC entry 4250 (class 0 OID 16752)
-- Dependencies: 250
...
--
-- TOC entry 4258 (class 0 OID 16875)
-- Dependencies: 258
-- Data for Name: recetas; Type: TABLE DATA; Schema: public; Owner: daniel
--

COPY public.recetas (id, nombre_receta, producto_resultado_id, descripcion, cantidad_resultado, unidad_medida_resultado_id, activo, fecha_creacion) FROM stdin;
\.


--
-- TOC entry 4220 (class 0 OID 16390)
-- Dependencies: 220
...
--
-- TOC entry 4252 (class 0 OID 16792)
-- Dependencies: 252
...
--
-- TOC entry 4230 (class 0 OID 16503)
-- Dependencies: 230
...
--
-- TOC entry 4240 (class 0 OID 16652)
-- Dependencies: 240
...
--
-- TOC entry 4254 (class 0 OID 16812)
-- Dependencies: 254
...
--
-- TOC entry 4244 (class 0 OID 16707)
-- Dependencies: 244
...
--
-- TOC entry 4228 (class 0 OID 16486)
-- Dependencies: 228
...
--
-- TOC entry 4248 (class 0 OID 16737)
-- Dependencies: 248
...
--
-- TOC entry 4226 (class 0 OID 16446)
-- Dependencies: 226
...
--
-- TOC entry 4236 (class 0 OID 16568)
-- Dependencies: 236
...
-- Dependencies: 265
-- Name: detalles_produccion_id_seq; Type: SEQUENCE SET; Schema: public; Owner: daniel
--
...
-- Dependencies: 259
-- Name: detalles_receta_id_seq; Type: SEQUENCE SET; Schema: public; Owner: daniel
--

SELECT pg_catalog.setval('public.detalles_receta_id_seq', 1, false);
...
-- Dependencies: 261
-- Name: estados_produccion_id_seq; Type: SEQUENCE SET; Schema: public; Owner: daniel
--

SELECT pg_catalog.setval('public.estados_produccion_id_seq', 1, false);
...
-- Dependencies: 267
-- Name: pasos_receta_id_seq; Type: SEQUENCE SET; Schema: public; Owner: daniel
--

SELECT pg_catalog.setval('public.pasos_receta_id_seq', 1, false);


--
-- TOC entry 4311 (class 0 OID 0)
-- Dependencies: 263
-- Name: producciones_id_seq; Type: SEQUENCE SET; Schema: public; Owner: daniel
--
...
-- Dependencies: 257
-- Name: recetas_id_seq; Type: SEQUENCE SET; Schema: public; Owner: daniel
--
...
--
-- TOC entry 3942 (class 2606 OID 16553)
...
--
-- TOC entry 3974 (class 2606 OID 16735)
...
--
-- TOC entry 3976 (class 2606 OID 16733)
...
--
-- TOC entry 4032 (class 2606 OID 16982)
-- Name: detalles_produccion detalles_produccion_pkey; Type: CONSTRAINT; Schema: public; Owner: daniel
--
...
--
-- TOC entry 4016 (class 2606 OID 16916)
-- Name: detalles_receta detalles_receta_pkey; Type: CONSTRAINT; Schema: public; Owner: daniel
--
...
--
-- TOC entry 3954 (class 2606 OID 16636)
...
--
-- TOC entry 3914 (class 2606 OID 16442)
...
--
-- TOC entry 3916 (class 2606 OID 16444)
...
--
-- TOC entry 3918 (class 2606 OID 16440)
...
--
-- TOC entry 3910 (class 2606 OID 16422)
...
--
-- TOC entry 3912 (class 2606 OID 16420)
...
--
-- TOC entry 4020 (class 2606 OID 16944)
-- Name: estados_produccion estados_produccion_nombre_key; Type: CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.estados_produccion
    ADD CONSTRAINT estados_produccion_nombre_key UNIQUE (nombre);


--
-- TOC entry 4022 (class 2606 OID 16942)
-- Name: estados_produccion estados_produccion_pkey; Type: CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.estados_produccion
    ADD CONSTRAINT estados_produccion_pkey PRIMARY KEY (id);


--
-- TOC entry 3938 (class 2606 OID 16536)
...
--
-- TOC entry 3940 (class 2606 OID 16534)
...
--
-- TOC entry 3968 (class 2606 OID 16685)
...
--
-- TOC entry 4007 (class 2606 OID 16847)
...
--
-- TOC entry 4039 (class 2606 OID 17011)
-- Name: pasos_receta pasos_receta_pkey; Type: CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.pasos_receta
    ADD CONSTRAINT pasos_receta_pkey PRIMARY KEY (id);


--
-- TOC entry 4030 (class 2606 OID 16959)
-- Name: producciones producciones_pkey; Type: CONSTRAINT; Schema: public; Owner: daniel
--
...
--
-- TOC entry 3987 (class 2606 OID 16775)
...
--
-- TOC entry 3989 (class 2606 OID 16773)
...
--
-- TOC entry 3991 (class 2606 OID 16771)
...
--
-- TOC entry 4012 (class 2606 OID 16894)
-- Name: recetas recetas_nombre_receta_key; Type: CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.recetas
    ADD CONSTRAINT recetas_nombre_receta_key UNIQUE (nombre_receta);


--
-- TOC entry 4014 (class 2606 OID 16892)
-- Name: recetas recetas_pkey; Type: CONSTRAINT; Schema: public; Owner: daniel
--
...
--
-- TOC entry 3906 (class 2606 OID 16405)
...
--
-- TOC entry 3908 (class 2606 OID 16403)
...
--
-- TOC entry 3995 (class 2606 OID 16803)
...
--
-- TOC entry 3997 (class 2606 OID 16805)
...
--
-- TOC entry 3934 (class 2606 OID 16519)
...
--
-- TOC entry 3936 (class 2606 OID 16517)
...
--
-- TOC entry 3960 (class 2606 OID 16667)
...
--
-- TOC entry 3962 (class 2606 OID 16665)
...
--
-- TOC entry 3999 (class 2606 OID 16828)
...
--
-- TOC entry 4001 (class 2606 OID 16826)
...
--
-- TOC entry 3970 (class 2606 OID 16720)
...
--
-- TOC entry 3972 (class 2606 OID 16718)
...
--
-- TOC entry 3930 (class 2606 OID 16501)
...
--
-- TOC entry 3932 (class 2606 OID 16499)
...
--
-- TOC entry 3978 (class 2606 OID 16750)
...
--
-- TOC entry 3980 (class 2606 OID 16748)
...
--
-- TOC entry 4041 (class 2606 OID 17013)
-- Name: pasos_receta uq_pasos_receta_orden; Type: CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.pasos_receta
    ADD CONSTRAINT uq_pasos_receta_orden UNIQUE (receta_id, orden_paso);


--
-- TOC entry 3924 (class 2606 OID 16465)
...
--
-- TOC entry 3926 (class 2606 OID 16461)
...
--
-- TOC entry 3928 (class 2606 OID 16463)
...
--
-- TOC entry 3952 (class 2606 OID 16589)
...
--
-- TOC entry 3945 (class 1259 OID 16565)
...
--
-- TOC entry 4033 (class 1259 OID 17030)
-- Name: idx_detalles_produccion_produccion_id; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_detalles_produccion_produccion_id ON public.detalles_produccion USING btree (produccion_id);


--
-- TOC entry 4034 (class 1259 OID 17031)
-- Name: idx_detalles_produccion_receta_id; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_detalles_produccion_receta_id ON public.detalles_produccion USING btree (receta_id);


--
-- TOC entry 4017 (class 1259 OID 17023)
-- Name: idx_detalles_receta_producto_insumo_id; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_detalles_receta_producto_insumo_id ON public.detalles_receta USING btree (producto_insumo_id);


--
-- TOC entry 4018 (class 1259 OID 17022)
-- Name: idx_detalles_receta_receta_id; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_detalles_receta_receta_id ON public.detalles_receta USING btree (receta_id);


--
-- TOC entry 3955 (class 1259 OID 16648)
...
--
-- TOC entry 3956 (class 1259 OID 16647)
...
--
-- TOC entry 3957 (class 1259 OID 16649)
...
--
-- TOC entry 3958 (class 1259 OID 16650)
...
--
-- TOC entry 3919 (class 1259 OID 16484)
...
--
-- TOC entry 4023 (class 1259 OID 17024)
-- Name: idx_estados_produccion_activo; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_estados_produccion_activo ON public.estados_produccion USING btree (activo);


--
-- TOC entry 4002 (class 1259 OID 16873)
...
--
-- TOC entry 4003 (class 1259 OID 16870)
...
--
-- TOC entry 4004 (class 1259 OID 16871)
...
--
-- TOC entry 4005 (class 1259 OID 16872)
...
--
-- TOC entry 3963 (class 1259 OID 16701)
...
--
-- TOC entry 3964 (class 1259 OID 16704)
...
--
-- TOC entry 3965 (class 1259 OID 16703)
...
--
-- TOC entry 3966 (class 1259 OID 16702)
...
--
-- TOC entry 4035 (class 1259 OID 17033)
-- Name: idx_pasos_receta_orden_paso; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_pasos_receta_orden_paso ON public.pasos_receta USING btree (orden_paso);


--
-- TOC entry 4036 (class 1259 OID 17032)
-- Name: idx_pasos_receta_receta_id; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_pasos_receta_receta_id ON public.pasos_receta USING btree (receta_id);


--
-- TOC entry 4037 (class 1259 OID 17034)
-- Name: idx_pasos_receta_receta_orden; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_pasos_receta_receta_orden ON public.pasos_receta USING btree (receta_id, orden_paso);


--
-- TOC entry 4024 (class 1259 OID 17029)
-- Name: idx_producciones_estado_produccion_id; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_producciones_estado_produccion_id ON public.producciones USING btree (estado_produccion_id);


--
-- TOC entry 4025 (class 1259 OID 17027)
-- Name: idx_producciones_fecha_fin; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_producciones_fecha_fin ON public.producciones USING btree (fecha_fin);


--
-- TOC entry 4026 (class 1259 OID 17026)
-- Name: idx_producciones_fecha_inicio; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_producciones_fecha_inicio ON public.producciones USING btree (fecha_inicio);


--
-- TOC entry 4027 (class 1259 OID 17025)
-- Name: idx_producciones_fecha_programada; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_producciones_fecha_programada ON public.producciones USING btree (fecha_programada);


--
-- TOC entry 4028 (class 1259 OID 17028)
-- Name: idx_producciones_usuario_id; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_producciones_usuario_id ON public.producciones USING btree (usuario_id);


--
-- TOC entry 3981 (class 1259 OID 16867)
...
--
-- TOC entry 3983 (class 1259 OID 16863)
...
--
-- TOC entry 3984 (class 1259 OID 16865)
...
--
-- TOC entry 3985 (class 1259 OID 16866)
...
--
-- TOC entry 4008 (class 1259 OID 17021)
-- Name: idx_recetas_activo; Type: INDEX; Schema: public; Owner: daniel
--
...
--
-- TOC entry 4009 (class 1259 OID 17019)
-- Name: idx_recetas_producto_resultado_id; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_recetas_producto_resultado_id ON public.recetas USING btree (producto_resultado_id);


--
-- TOC entry 4010 (class 1259 OID 17020)
-- Name: idx_recetas_unidad_medida_resultado_id; Type: INDEX; Schema: public; Owner: daniel
--

CREATE INDEX idx_recetas_unidad_medida_resultado_id ON public.recetas USING btree (unidad_medida_resultado_id);


--
-- TOC entry 3992 (class 1259 OID 16869)
...
--
-- TOC entry 3920 (class 1259 OID 16481)
...
--
-- TOC entry 3921 (class 1259 OID 16483)
...
--
-- TOC entry 3922 (class 1259 OID 16482)
...
--
-- TOC entry 3946 (class 1259 OID 16613)
...
--
-- TOC entry 3947 (class 1259 OID 16610)
...
--
-- TOC entry 3948 (class 1259 OID 16614)
...
--
-- TOC entry 3949 (class 1259 OID 16612)
...
--
-- TOC entry 3950 (class 1259 OID 16611)
...
--
-- TOC entry 4045 (class 2606 OID 16554)
...
--
-- TOC entry 4046 (class 2606 OID 16559)
...
--
-- TOC entry 4051 (class 2606 OID 16642)
...
--
-- TOC entry 4052 (class 2606 OID 16637)
...
--
-- TOC entry 4069 (class 2606 OID 16988)
-- Name: detalles_produccion fk_detalles_produccion_produccion; Type: FK CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.detalles_produccion
    ADD CONSTRAINT fk_detalles_produccion_produccion FOREIGN KEY (produccion_id) REFERENCES public.producciones(id);


--
-- TOC entry 4070 (class 2606 OID 16983)
-- Name: detalles_produccion fk_detalles_produccion_receta; Type: FK CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.detalles_produccion
    ADD CONSTRAINT fk_detalles_produccion_receta FOREIGN KEY (receta_id) REFERENCES public.recetas(id);


--
-- TOC entry 4065 (class 2606 OID 16922)
-- Name: detalles_receta fk_detalles_receta_producto_insumo; Type: FK CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.detalles_receta
    ADD CONSTRAINT fk_detalles_receta_producto_insumo FOREIGN KEY (producto_insumo_id) REFERENCES public.productos(id);


--
-- TOC entry 4066 (class 2606 OID 16917)
-- Name: detalles_receta fk_detalles_receta_receta; Type: FK CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.detalles_receta
    ADD CONSTRAINT fk_detalles_receta_receta FOREIGN KEY (receta_id) REFERENCES public.recetas(id);


--
-- TOC entry 4053 (class 2606 OID 16686)
...
--
-- TOC entry 4055 (class 2606 OID 16691)
...
--
-- TOC entry 4060 (class 2606 OID 16848)
...
--
-- TOC entry 4061 (class 2606 OID 16853)
...
--
-- TOC entry 4062 (class 2606 OID 16858)
...
-- Name: pasos_receta fk_pasos_receta_receta; Type: FK CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.pasos_receta
    ADD CONSTRAINT fk_pasos_receta_receta FOREIGN KEY (receta_id) REFERENCES public.recetas(id);


--
-- TOC entry 4067 (class 2606 OID 16965)
-- Name: producciones fk_producciones_estado; Type: FK CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.producciones
    ADD CONSTRAINT fk_producciones_estado FOREIGN KEY (estado_produccion_id) REFERENCES public.estados_produccion(id);


--
-- TOC entry 4068 (class 2606 OID 16960)
-- Name: producciones fk_producciones_usuario; Type: FK CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.producciones
    ADD CONSTRAINT fk_producciones_usuario FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id);


--
-- TOC entry 4056 (class 2606 OID 16776)
...
--
-- TOC entry 4057 (class 2606 OID 16781)
...
--
-- TOC entry 4058 (class 2606 OID 16786)
...
--
-- TOC entry 4063 (class 2606 OID 16895)
-- Name: recetas fk_recetas_producto_resultado; Type: FK CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.recetas
    ADD CONSTRAINT fk_recetas_producto_resultado FOREIGN KEY (producto_resultado_id) REFERENCES public.productos(id);


--
-- TOC entry 4064 (class 2606 OID 16900)
-- Name: recetas fk_recetas_unidad_medida_resultado; Type: FK CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.recetas
    ADD CONSTRAINT fk_recetas_unidad_medida_resultado FOREIGN KEY (unidad_medida_resultado_id) REFERENCES public.unidades_medida(id);


--
-- TOC entry 4059 (class 2606 OID 16806)
...
--
-- TOC entry 4042 (class 2606 OID 16466)
...
--
-- TOC entry 4043 (class 2606 OID 16476)
...
--
-- TOC entry 4044 (class 2606 OID 16471)
...
--
-- TOC entry 4047 (class 2606 OID 16605)
...
--
-- TOC entry 4048 (class 2606 OID 16595)
...
--
-- TOC entry 4049 (class 2606 OID 16600)
...
--
-- TOC entry 4050 (class 2606 OID 16590)
...
-- Completed on 2026-04-27 15:09:08 -05

--
-- PostgreSQL database dump complete
--

\unrestrict l5igCawJzw7Bs0q5y5nHvh9zds6QAYHl7rjFhdY7L6DutQn50f128zFFsvD4RWc
